    ...
    <div class="container">
      <h3>Agregar Propiedad</h3>
          ...
          <form name="agregacion" id="agregacion" method="post" enctype="multipart/form-data">
            ...
            <input type="text" class="span2" required id="direccion" name="direccion" placeholder="Direccion">
            <input type="text" class="span2" required id="localidad" name="localidad" placeholder="Localidad">
            <input type="text" class="span2" required id="provincia" name="provincia" placeholder="Provincia">
            <input type="text" class="span2" required id="pais" name="pais" placeholder="Pais">
            ...
            <input type="number" class="span2" name="precio" required placeholder="Precio">
            </div><br>
            <label>Hambientes</label>
            <input type="number" class="span2" required name="hambientes">
            <br>
            
            <label class="checkbox">
    		<input name="activo" type="checkbox" checked="CHECKED"> Activo
  			</label>
            <label class="checkbox">
...
<br>
<br>
<button type="submit" id="agregar_btn" class="btn btn-success btn-large">Agregar</button>
</form>
          </div>
          <?php } ?>
